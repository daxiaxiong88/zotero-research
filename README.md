...
2. 「工具 → 插件 → 齿轮 → 从文件安装插件」，选择 `dist/zotero-research-0.5.2.xpi`。
...
从 0.5.1 更新到 0.5.2 只需更新 XPI；现有 1.0.2 油猴脚本、API 配置和对话存档继续使用。提示词结构、材料范围与验收边界见 [提示词设计说明](docs/PROMPT_DESIGN.md)。
